...
export class BucketlistItemService {
  ...
  getItem(bucketlist_id: number, id: number): Observable<Item>{
    return this.http.get(this.itemUrl + "bucketlists/" + bucketlist_id + "/items/" + id,
  ...
  edit(bucketlist_id: number, id: number, payload: any) {
    return this.http.put(this.itemUrl + "bucketlists/" + bucketlist_id + "/items/" + id,
  ...
  delete(bucketlist_id: number, id: number) {
    return this.http.delete(this.itemUrl + "bucketlists/" + bucketlist_id + "/items/" + id,
      {headers: this.headers})
      .map(response => response.json().message)
      .catch(this.handleError);
  }
  ...
  create(bucketlist_id: number, payload: any) {
    return this.http.post(this.itemUrl + "bucketlists/" + bucketlist_id + "/items", payload,
      {headers: this.headers})
      .map(response => response.json().message)
      .catch(this.handleError)
  }
